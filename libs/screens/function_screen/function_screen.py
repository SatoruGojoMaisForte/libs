...
class FunctionScreen(MDScreen):
    ...
    def screen_finalize(self):
        ...
        self.ids['btc'] = botton
        self.ids.btc.on_release = self.functions
    ...
    def functions(self):
        ...
        self.ids.encargo.text = ''

        # apagando dados da opção de pagamento
        self.ids.text_payment.text = 'Ausente'
        self.ids.text_payment.text_color = 'red'
        self.manager.current = 'Functions'

        # apagando dados do salario
        self.ids.remunaration.text = ''
    ...
    def step_two(self):
        ...
        data = {
            ...
            'Salary': salary,
            'occupation': self.ids.encargo.text
        }
