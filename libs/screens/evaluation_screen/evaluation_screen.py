...
class EvaluationScreen(MDScreen):
    ...
    def on_enter(self, *args):
        ...
        if self.method_salary not in 'Empreita':
            ...
            self.ids.frequency_text.text = 'Frequencia'
            ...
            self.ids.value_salary.text = f'{self.format_salary(self.salary)}'
    ...
    def next_edit(self):
        ...
        edit_profile = screenmanager.get_screen('EditProfileEmployee')
        edit_profile.avatar = self.ids.perfil.source
        edit_profile.method_salary = self.method_salary
        edit_profile.salary = self.salary
        edit_profile.employee_name = self.employee_name
        edit_profile.scale = self.scale
        edit_profile.key = self.key
        self.manager.transition = SlideTransition(direction='right')
